...
struct HourlyWeatherData: Codable {
  ...
  /// Daylight for this specific hour. Optional so entries cached by an older
  /// build still decode.
  var isDay: Bool? = nil
}

/// Which backend produced a response. Drives attribution: Apple requires the
/// Apple Weather mark on screen whenever WeatherKit data is displayed.
...
struct WeatherResponse: Codable {
  ...
  /// Optional so entries cached by an older build still decode.
